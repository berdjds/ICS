...
export function FooterContent() {
  return (
    ...
    >
      <motion.div variants={itemVariants} className="flex flex-col items-center gap-3 md:gap-4">
        <Image
      ...
      <motion.div variants={itemVariants} className="w-full">
        <h3 className="text-xl md:text-2xl font-bold text-[#006398] mb-2 md:mb-2">Contact Information</h3>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-3 md:mb-4">
          <motion.div
            className="flex flex-col items-center gap-2 md:gap-3 p-3 md:p-4 bg-gray-900/30 rounded-lg border border-gray-800 backdrop-blur-sm"
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-xs md:text-sm">Dubai, United Arab Emirates</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-center">
              <h4 className="font-semibold text-white mb-1 text-sm md:text-base">Phone</h4>
              <p className="text-gray-300 text-xs md:text-sm">(+971) 4 835 8795</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-xs md:text-sm">info@intel-cs.com</p>
            </div>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        <p className="text-xs md:text-sm text-white-500 font-bold">© 2025 iNTEL-CS. All rights reserved.</p>
      </motion.div>
    </motion.div>
  )
}
