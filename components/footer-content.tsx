    ...
    >
      ...
      <motion.div variants={itemVariants} className="w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-3 md:mb-4">
          <motion.div
            className="flex flex-col items-center gap-2 md:gap-3 p-3 md:p-4 bg-gray-900/30 rounded-lg border border-gray-800 backdrop-blur-sm hover:border-[#006398] transition-all duration-300"
            variants={itemVariants}
